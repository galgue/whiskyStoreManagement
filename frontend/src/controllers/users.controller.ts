...
interface loginProps extends CommonController<User> {
    ...
    isLogged: () => Promise<AxiosResponse<{userName: String, isManager: Boolean, email: string}>>,
...
export const UserController:loginProps = {
    ...
    isLogged: () => storeAxios.post<{userName: String, isManager: Boolean, email: string}>('users/islogged'),
